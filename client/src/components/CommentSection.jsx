...
// 👇 Thêm prop isChild để nhận biết đây là reply hay comment gốc
  ...
  return (
    <div className="mb-6 animate-in fade-in slide-in-from-bottom-2">
      <div className="flex gap-3 mb-6">
        {/* Avatar */}
        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-green-400 to-blue-500 flex items-center justify-center text-xs font-bold text-black flex-shrink-0 uppercase select-none">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 mt-2">
            ...
            {/* 🛑 LOGIC MỚI: Chỉ hiện nút Reply nếu KHÔNG PHẢI là comment con (isChild = false) */}
            {!isChild && (
                <button 
          ...
          {/* Form Reply Inline (Chỉ hiện nếu được phép reply) */}
        ...
        <div className="ml-4 pl-3 border-l border-neutral-800 mt-2">
          {comment.replies.map(reply => (
             <CommentItem 
                ...
                isChild={true} // 👈 Đánh dấu các comment con là child để ẩn nút Reply đi
             />
          ))}
        </div>
      )}
