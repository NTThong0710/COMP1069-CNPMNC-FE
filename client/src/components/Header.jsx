          ...
          <div ref={dropdownRef} className="relative w-full max-w-md group">
            <form onSubmit={handleSearchSubmit} className="relative">
              ...
              <input
                ...
                className={`w-full rounded-full py-3 pl-10 pr-12 transition-colors shadow-sm focus:outline-none ${
                  isUserLoggedIn
                  ...
                  <div className="mb-2">
                    ...
                    {suggestions.songs.map((song, idx) => (
                      <div
                        ...
                        className="px-2 py-1.5 hover:bg-neutral-700/50 rounded-md cursor-pointer flex items-center gap-3 transition-colors"
                      >
                        {song.cover ? (
                          <img
                            src={song.cover}
                            alt=""
                            className="w-10 h-10 rounded-md object-cover bg-neutral-800"
                          />
                        ) : (
