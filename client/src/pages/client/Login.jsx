  ...
  return (
    <form onSubmit={(e) => { e.preventDefault(); onNext(email); }}>
      ...
      <div className="space-y-3">
        <button type="button" className="w-full bg-white text-black font-medium py-3 rounded-full hover:bg-neutral-200 transition flex items-center justify-center gap-3">
