...
// kafka
const { connectProducer, sendMessage } = require('./services/kafka/producer');
const {
  connectConsumer,
  consumerMessage,
} = require('./services/kafka/consumer');
const TOPICS = require('./services/kafka/topics');
...
const startKafka = async () => {
  ...
  await consumerMessage(TOPICS.TEST_TOPIC, (data) => {
    console.log('Received', data);
  });
  await sendMessage(TOPICS.TEST_TOPIC, { text: 'Hello Kafka!' });
};
