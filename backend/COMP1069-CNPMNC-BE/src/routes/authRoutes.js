...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      const user = req.user;
      if (!user)
        return res.redirect(process.env.CLIENT_URL || "https://musicwebapp-eight.vercel.app");
      ...
      const redirectBase = process.env.CLIENT_URL || "https://musicwebapp-eight.vercel.app";
